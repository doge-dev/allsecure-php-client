...
class Client {
    ...
    public function validateCallback($requestBody, $requestQuery, $dateHeader, $authorizationHeader) {
        ...
        $expectedSig = 'Exchange ' . $this->getApiKey() . ':' . $digest;
    ...
    /**
     * Sets the Exchange Gateway url (API URL) to the given one. This allows to set up a development/test environment.
    ...
    public static function getDefaultUrl() {
        return static::DEFAULT_EXCHANGE_URL;
    }
    ...
    public static function resetApiUrl() {
        static::setApiUrl(static::DEFAULT_EXCHANGE_URL);
    }
